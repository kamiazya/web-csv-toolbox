...
describe("parseString function", () => {
  ...
  it("should throw an error if the CSV is invalid", async () => {
    await expect(async () => {
...
describe("parseString with execution strategies", () => {
  ...
  it.skipIf(typeof window === "undefined")(
    "should handle invalid options in worker execution",
    async () => {
      await expect(async () => {
        for await (const _ of parseString("", {
          engine: { worker: true },
  ...
  it.skipIf(typeof window === "undefined")(
    "should produce identical results across all execution strategies",
    () =>
      fc.assert(
        fc.asyncProperty(
          fc.gen().map((g) => {
  ...
  it.skipIf(typeof window === "undefined")(
    "should handle concurrent parsing requests in worker",
    async () => {
      const csv1 = "a,b,c\n1,2,3\n4,5,6";
      const csv2 = "x,y,z\n7,8,9\n10,11,12";
      const csv3 = "p,q,r\n13,14,15\n16,17,18";
