...
/**
 * UTF-16 optimized WASM parser for string inputs (array output format).
 */
export class WASMStringUtf16ArrayCSVParser<
...
> implements StringArrayCSVParser<Header>
{
  ...
  *parse(
  ...
  private *flush(): IterableIterator<CSVArrayRecord<Header>> {
