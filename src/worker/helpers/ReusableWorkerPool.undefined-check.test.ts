 ...
 */
describe("ReusableWorkerPool undefined checks", () => {
  ...
  // TODO: This test is skipped because blob URLs are not supported in Node.js Worker
  // This feature only works in browser environments where Workers can accept blob URLs
  it.skip("should handle getWorker with custom URL", async () => {
    // Create a simple worker blob for testing
    // Note: This test only works in browser environments
