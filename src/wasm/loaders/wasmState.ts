...
const SIMD_TEST_BYTES = new Uint8Array([
  ...
  0x01, 0x05, 0x01, 0x60, // type section: 1 function type, params: () -> ()
  0x00, 0x00, 0x03, 0x02, // function section: 1 function
  0x01, 0x00, 0x0a, 0x12, // code section
  0x01, 0x10, 0x00, // 1 function body, 16 bytes, 0 locals
  0xfd, 0x0c, // v128.const
  0x00, 0x00, 0x00, 0x00, // i32x4 lane 0
  0x00, 0x00, 0x00, 0x00, // i32x4 lane 1
  0x00, 0x00, 0x00, 0x00, // i32x4 lane 2
  0x00, 0x00, 0x00, 0x00, // i32x4 lane 3
  0x1a, // drop
  0x0b, // end
]);
