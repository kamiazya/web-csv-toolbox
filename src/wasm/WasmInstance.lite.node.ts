/**
 * WASM instance management for lite version (Node.js optimized).
 *
 * **Note:** This file has an identical implementation to `WasmInstance.lite.ts`, but they must be
 ...
 * @example
 * ```ts
 * import { isWASMReady } from 'web-csv-toolbox/lite';
 *
 * if (isWASMReady()) {
