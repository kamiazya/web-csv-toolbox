# Vite Bundle Example - Lite Version

This example demonstrates bundling web-csv-toolbox's lite entry point with streaming WASM loading.
...
The lite version loads WASM via streaming fetch, which is more efficient for production use:
