...
![npm package minimized gzipped size](https://img.shields.io/bundlejs/size/{{name}})
![GitHub code size in bytes](https://img.shields.io/github/languages/code-size/kamiazya/web-csv-toolbox)
![npm](https://img.shields.io/npm/dm/{{name}})
...
{{description}}
{% if name contains '@web-csv-toolbox/' %}
...
[![npm](https://img.shields.io/badge/-npm-CB3837?logo=npm&style=flat)](https://www.npmjs.com/package/{{name}})
