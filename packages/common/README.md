...
[![npm version](https://badge.fury.io/js/@web-csv-toolbox/common.svg)](https://badge.fury.io/js/@web-csv-toolbox/common)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)
[![PRs Welcome](https://img.shields.io/badge/PRs-welcome-brightgreen.svg)](http://makeapullrequest.com)
![node version](https://img.shields.io/node/v/@web-csv-toolbox/common)
...
![npm package minimized gzipped size](https://img.shields.io/bundlejs/size/@web-csv-toolbox/common)
![GitHub code size in bytes](https://img.shields.io/github/languages/code-size/kamiazya/web-csv-toolbox)
![npm](https://img.shields.io/npm/dm/@web-csv-toolbox/common)
...
[![npm](https://img.shields.io/badge/-npm-CB3837?logo=npm&style=flat)](https://www.npmjs.com/package/@web-csv-toolbox/common)
...
```sh
# Install with npm
$ npm install @web-csv-toolbox/common
# Or Yarn
$ yarn add @web-csv-toolbox/common
# Or pnpm
$ pnpm add @web-csv-toolbox/common
```
